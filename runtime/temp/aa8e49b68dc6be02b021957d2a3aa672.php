<?php /*a:2:{s:75:"/home/gemxpbra/public_html/application/admin/view/system/exchange_edit.html";i:1697722712;s:89:"/home/gemxpbra/public_html/application/admin/view/../../../public/static/common/base.html";i:1697722706;}*/ ?>
<!DOCTYPE html>
        ...
        <form class="layui-form" action="" method="post">
            <!-- <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="c_name" value="<?php echo htmlentities($info['c_name']); ?>" required  lay-verify="required|title" placeholder="请输入中文名称" autocomplete="off" class="layui-input">
                </div>
            </div> -->
            <div class="layui-form-item">
                <label class="layui-form-label">英文名称<span class="x-red">*</span></label>
                <div class="layui-input-block">
                    <input type="text" name="e_name" value="<?php echo htmlentities($info['e_name']); ?>" placeholder="请输入英文名称" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <div class="thumbnail_box" id="thumbnail_box">
                        <img id="thumbnail_img" src="<?php echo htmlentities($info['img']); ?>" alt="" width="100" onclick="$('#thumbnail').click()">
                        <input type="button" class="layui-btn layui-btn-danger" onclick="delete_thumbnail()" value="删除">
                    </div>
                    <input type="hidden" name="thumbnail" value="<?php echo htmlentities($info['img']); ?>" id="thumbnail_value">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">链接<span class="x-red">*</span></label>
                <div class="layui-input-block">
                    <input type="text" name="url" value="<?php echo htmlentities($info['url']); ?>"  placeholder="请输入链接" class="layui-input">
                </div>
            </div>
